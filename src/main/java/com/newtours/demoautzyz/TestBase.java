package com.newtours.demoautzyz;
...
public static WebDriver driver;
 ...
 public TestBase() {
  try {
   prop = new Properties();
   FileInputStream ip = new FileInputStream("C:\\Users\\hp\\eclipse-workspace\\com.newtours.demoaut123\\src\\main\\java\\com\\newtours\\demoautxyzconfig\\config.properties");
   prop.load(ip);
